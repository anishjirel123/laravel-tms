...
<div class="container py-2">
  ...
  <div class="card">
    <div class="card-header text-center" style="font-weight:700; font-size:30px; text-shadow: 2px 2px #FF0000;">
      Index Tasks Management Table
    </div>
    <div class="container py-2">
  <a name="" id="" class="btn btn-warning" href="{{route('task.create')}}" role="button"><i class="fa-solid fa-arrow-left"></i></a>
  <a name="" id="" class="btn btn-primary" href="" role="button" style="font-weight:600">Add Create Tasks</a>
</div>
    <div class="card-body">
    ...
    <div class="card-footer text-muted d-flex align-items-center justify-content-center fs-6">
